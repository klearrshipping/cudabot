...
class InvoiceExtractor:
    ...
    def _create_extraction_prompt(self) -> str:
        ...
        return """You are a document extraction specialist. Your task is to analyze this invoice document and extract ALL information present in the document.
